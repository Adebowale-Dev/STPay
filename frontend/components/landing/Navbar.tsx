...
export function Navbar() {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 border-b border-[rgba(13,23,48,0.08)] bg-[rgba(251,251,248,0.96)] text-[var(--brand-navy)]">
      ...
      {open ? (
        <div className="border-t border-border bg-[rgba(251,251,248,0.98)] px-4 py-4 md:hidden sm:px-6">
